...
onRequest = () => {
    ...
    .then((response,data) => {
      ...
      if (response.ok) {
        ...
        alert("ERROR TYPE 2 : ขออภัยในความไม่สะดวกค่ะ ขณะนี้เซิฟเวอร์ไม่พร้อมให้บริการ กรุณาลองใหม่อีกครั้งในภายหลัง หรือติดต่อเพจเฟซบุ๊ก ค่ายจุฬาฯ-ชลบุรี")
      }
      // console.log('Success:', data);
      // this.props.history.push('/success');
    })
    .catch((error) => {
      ...
      alert("ERROR TYPE 1 : ขออภัยในความไม่สะดวกค่ะ ขณะนี้เซิฟเวอร์ไม่พร้อมให้บริการ กรุณาลองใหม่อีกครั้งในภายหลัง หรือติดต่อเพจเฟซบุ๊ก ค่ายจุฬาฯ-ชลบุรี");
    });
  } 
